...
function my_theme_create_options() {
    ...
    $generaltab->createOption( array(
        'name' => 'Home Page banner image Left',
        'id' => 'home_img_one',
        'type' => 'upload',
        'desc' => 'Upoad Home Page banner image which is displayed under the home slider section Left.'
    ) );
    $generaltab->createOption( array(
        'name' => 'Link URL of the Banner Image',
        'id' => 'home_txt_one',
        'type' => 'text',
        'desc' => 'Enter Link URL of the Left Banner Image.'
    ) );

    $generaltab->createOption( array(
        'name' => 'Home Page banner image Right',
        'id' => 'home_img_two',
        'type' => 'upload',
        'desc' => 'Upoad Home Page banner image which is displayed under the home slider section Right.'
    ) );
    $generaltab->createOption( array(
        'name' => 'Link URL of the Banner Image',
        'id' => 'home_txt_two',
        'type' => 'text',
        'desc' => 'Enter Link URL of the Right Banner Image.'
    ) );
